...
### 🌐 Optional: Web Visualization Console

If you prefer a browser-based workflow, you can launch the built-in web console to manage exploration/deployment jobs with complete interactive fields (mode, app name, task description, and root directory):
